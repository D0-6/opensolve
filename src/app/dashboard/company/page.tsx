            ...
            {myProblems.map((problem: any) => {
              ...
              return (
                <div
                  ...
                  className="border-b border-zinc-200 py-6 px-4 hover:bg-zinc-50 transition-colors -mx-4 group border-l-4 border-l-transparent hover:border-l-[#b91c1c]"
                >
                  <div className="flex flex-wrap gap-4 items-start justify-between">
                    <div className="flex-1 min-w-[200px]">
                      <h3 className="text-lg font-semibold text-zinc-900 mb-1 group-hover:text-[#b91c1c] transition-colors">{problem.title}</h3>
