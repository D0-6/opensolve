  ...
  return (
    <div className="bg-white min-h-screen text-zinc-900 selection:bg-zinc-200">
      ...
      <section className="pt-32 pb-24 px-6">
        <div className="max-w-5xl mx-auto flex flex-col items-start gap-6 fade-in-up">
      ...
      <section className="border-y border-zinc-200 bg-zinc-50 fade-in-up delay-100">
        <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between divide-y md:divide-y-0 md:divide-x divide-zinc-200 py-6 md:py-0">
