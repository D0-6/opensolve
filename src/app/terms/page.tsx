    ...
    <div className="min-h-screen bg-transparent pt-24 pb-32 px-6">
      <div className="w-full max-w-[125rem] mx-auto space-y-16">
        ...
        <div className="border-b border-white/10 pb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-medium text-white tracking-tight mb-6">Terms of Service</h1>
        ...
        <div className="space-y-12 text-zinc-400 text-base leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-4">2. Account Registration and Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-4">3. Challenge Postings and Awards</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-4">5. Disclaimer of Warranties and Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-medium text-white mb-4">6. Changes to Terms</h2>
            <p>
