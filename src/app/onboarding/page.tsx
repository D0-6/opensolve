...
export default async function OnboardingPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-transparent/5">
      <div className="max-w-2xl w-full bg-transparent border border-white/10 p-8 md:p-12 fade-in-up">
        
        <div className="w-16 h-16 bg-transparent/10 border border-white/10 text-white flex items-center justify-center mb-8">
        ...
        <div className="bg-transparent/5 border border-white/10 p-6 mb-8">
          <h3 className="font-semibold text-white mb-3">By agreeing to the terms, you acknowledge that:</h3>
          <ul className="list-disc pl-5 space-y-2 text-zinc-400 text-sm">
            <li>You have read and agree to the <Link href="/terms" target="_blank" className="text-white font-medium hover:underline">Terms of Service</Link>.</li>
            <li>You have read and agree to the <Link href="/privacy" target="_blank" className="text-white font-medium hover:underline">Privacy Policy</Link>.</li>
