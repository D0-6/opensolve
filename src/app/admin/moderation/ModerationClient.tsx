  ...
  if (problems.length === 0) {
    return (
      <div className="bg-white border border-zinc-200 rounded-xl p-12 text-center shadow-sm">
        ...
        <p className="text-zinc-500 mt-2">There are no pending submissions in the queue right now.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-4">
      {problems.map((problem) => (
        <div key={problem.problemId} className="bg-white border border-zinc-200 rounded-xl shadow-sm overflow-hidden flex flex-col md:flex-row md:items-center">
          ...
          <div className="flex-1 p-6">
            ...
            <h3 className="text-lg font-semibold text-zinc-900 mb-1">{problem.title}</h3>
            
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 text-sm text-zinc-500 mt-3">
          ...
          <div className="bg-zinc-50 border-t md:border-t-0 md:border-l border-zinc-200 p-4 md:p-6 flex flex-row md:flex-col gap-3 justify-end sm:justify-start">
            <button
            ...
            <button
              ...
              disabled={processing === problem.problemId}
              className="flex-1 md:flex-none flex items-center justify-center gap-2 px-4 py-2.5 bg-white border border-zinc-200 text-red-600 hover:bg-red-50 text-sm font-medium rounded-lg transition-colors disabled:opacity-50"
            >
