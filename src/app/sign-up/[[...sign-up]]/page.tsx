      ...
      <div className="min-h-screen bg-white/5 flex flex-col items-center justify-center py-10 px-6">
        ...
        <div className="w-full max-w-md space-y-4">
          ...
          >
            ...
            <div>
              <h2 className="text-lg font-medium text-white mb-1">I&apos;m a Student / Builder</h2>
              <p className="text-sm text-zinc-400">I want to solve challenges, build my reputation, and get hired.</p>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <h2 className="text-lg font-medium text-white mb-1">I&apos;m an Organization</h2>
              <p className="text-sm text-zinc-400">I want to post challenges and hire top vetted talent.</p>
            </div>
          </button>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-white/5 flex flex-col items-center justify-center py-10 px-6">
      <div className="mb-8 text-center">
        ...
        <button 
          ...
          className="text-xs text-zinc-400 hover:text-white underline mt-4"
        >
          Change Role
        </button>
      </div>
